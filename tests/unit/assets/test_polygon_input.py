...
from osm_polygon_image_tag.assets.polygon_input import _panoramax_pair, _panoramax_pairs
...
def test_panoramax_pair_accepts_supported_shapes(value: object, expected: object) -> None:
    assert _panoramax_pair(value) == expected
